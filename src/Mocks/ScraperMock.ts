...
export class ScraperMock implements Scraper.IScraperMock{
  public GetScraperMocks() :Scraper.IScrapedWebsiteConfiguration[]{
    return [
      this.getMemoryExpressMock(), 
      this.getNewEggMock() 
    ]
  }
  private getMemoryExpressMock(): Scraper.IScrapedWebsiteConfiguration {
    return {
      Name: "Memory Express",
  ...
  private getNewEggMock(): Scraper.IScrapedWebsiteConfiguration {
    return {
      Name: "New Egg",
